...
public class AdminMainActivity2 extends Activity {
    
    ListView list;
    AdminLazyAdapter adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url=webaddr.urladdr()+"AdminJSONEventInfoServlet";
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				for (int i=0;i<jarray.length();i++)
				{
					...
					Events eve=new Events(imgnm, event_name, e_info, e_date, address,Uemail);					
					eventList.add(eve);
					
				}
				adapter=new AdminLazyAdapter(AdminMainActivity2.this,eventList);
