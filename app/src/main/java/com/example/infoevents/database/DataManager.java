package com.example.infoevents.database;
...
public class DataManager extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "infoevents";
    ...
    public DataManager(Context context, String databasename, CursorFactory factory, int version) {
